...
public class PrayerTimesListAdapter extends RecyclerView.Adapter<PrayerTimesListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public PrayerTimesListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_prayer,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull PrayerTimesListAdapter.ViewHolder holder, int position) {
